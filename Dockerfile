...
#
# golang:1.25-bookworm is based on debian:bookworm, this is important to ensure we have libc compatibility for the copied binary

FROM --platform=linux/amd64 docker.io/amd64/golang:1.25-bookworm AS builder-amd64
...
# See comment above about golang:1.25-bookworm why debian:bookworm is set here
